...
const tableData = [
  { name: 'Inventory_Valuation_Oct23', generated: 'Admin_01 (System)', format: 'CSV', status: 'Complete', action: 'Download' },
  { name: 'Quarterly_Tax_Statement_Q3', generated: 'M. Thompson', format: 'PDF', status: 'Complete', action: 'Download' },
  { name: 'Daily_Sales_Summary_2410', generated: 'S. Richards', format: 'CSV', status: 'Processing', action: 'Wait...' },
]
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-xs divide-y divide-outline-variant/10">
                {tableData.map((item, i) => (
                  <tr key={i} className="group transition-colors hover:bg-surface-container-low/20">
                    <td className="px-8 py-5 font-bold text-on-surface">{item.name}</td>
                    <td className="px-8 py-5 text-on-surface-variant">{item.generated}</td>
