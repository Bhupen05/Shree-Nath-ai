    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-surface-container-lowest rounded-3xl shadow-2xl border border-outline-variant/10 overflow-hidden">
          <div className="p-8">
            <p className="text-xs font-bold text-primary uppercase tracking-widest mb-2">Welcome Back</p>
            <h2 className="text-3xl font-black tracking-tight text-on-surface mb-1">Sign In</h2>
            <p className="text-sm text-on-surface-variant mb-8">Enter your credentials to access SIBMS.</p>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                {fieldErrors.email && (
                  <p className="text-[11px] text-error font-bold">{fieldErrors.email}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {fieldErrors.password && (
                  <p className="text-[11px] text-error font-bold">{fieldErrors.password}</p>
                )}
              </div>
